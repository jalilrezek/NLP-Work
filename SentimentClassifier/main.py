...
def single_run(dev_d: Dict[str, List[Union[str, int]]],
    ...
    # you can run this function to train and evaluate your model, and visualize the training process with a plot
...
def explore_embeddings(dev_d: Dict[str, List[Union[str, int]]],
                       train_d: Dict[str, List[Union[str, int]]],
                       test_d: Dict[str, List[Union[str, int]]]):
    # you can run this function to initialize and train your model with different embeddings, and visualize the performance across different embeddings with two plots
